...
public:
    ...
    static void jsOnRegisterResult(const std::string& bridgeName, bool available, int32_t bridgeType);
    ...
    static void PlatformCallMethod(
        const std::string& bridgeName, const std::string& methodName, const std::string& parameter);
    static std::string PlatformCallMethodResult(const std::string& bridgeName,
    ...
    static void PlatformSendMethodResultBinary(
        const std::string& bridgeName, const std::string& methodName,
    ...
    static std::unique_ptr<BufferMapping> PlatformCallMethodBinarySync(
        const std::string& bridgeName, const std::string& methodName,
        std::unique_ptr<BufferMapping> parameter, int32_t& errorCode);
