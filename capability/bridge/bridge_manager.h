...
public:
    ...
    static bool JSRegisterBridge(
        int32_t instanceId, std::shared_ptr<BridgeReceiver> callback);
    static void JSUnRegisterBridge(int32_t instanceId, const std::string& bridgeName);
    static void JSCallMethod(int32_t instanceId,
        const std::string& bridgeName, const std::string& methodName, const std::string& parameter);
    static void JSSendMethodResult(int32_t instanceId,
