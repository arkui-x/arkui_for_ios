...
#ifndef FOUNDATION_ACE_ADAPTER_IOS_CAPABILITY_EDITING_TEXT_INPUT_CLIENT_HANDLER_H
#define FOUNDATION_ACE_ADAPTER_IOS_CAPABILITY_EDITING_TEXT_INPUT_CLIENT_HANDLER_H
...
public:
    ...
    TextInputConnection* GetCurrentConnection()
    {
        if (currentConnection_) {
            return AceType::RawPtr(currentConnection_);
        }
        return nullptr;
    }
...
#endif // FOUNDATION_ACE_ADAPTER_IOS_CAPABILITY_EDITING_TEXT_INPUT_CLIENT_HANDLER_H