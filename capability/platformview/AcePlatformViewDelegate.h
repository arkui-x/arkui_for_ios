 ...
 */
#ifndef FOUNDATION_ADAPTER_CAPABILITY_PLATFORMVIEW_ACEPLATFORMVIEWDELEGATE_H
#define FOUNDATION_ADAPTER_CAPABILITY_PLATFORMVIEW_ACEPLATFORMVIEWDELEGATE_H

#import <Foundation/Foundation.h>

@protocol AcePlatformViewDelegate <NSObject>
