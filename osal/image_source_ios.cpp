...
RefPtr<PixelMap> ImageSourceIOS::CreatePixelMap(int32_t width, int32_t height)
{
    return CreatePixelMap(0, width, height);
}

RefPtr<PixelMap> ImageSourceIOS::CreatePixelMap(uint32_t index, int32_t width, int32_t height)
{
