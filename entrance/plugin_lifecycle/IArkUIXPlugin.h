...
#ifndef FOUNDATION_ACE_ADAPTER_IOS_ENTRANCE_PLUGINLIFECYCLE_IARKUIXPLUGIN_H
#define FOUNDATION_ACE_ADAPTER_IOS_ENTRANCE_PLUGINLIFECYCLE_IARKUIXPLUGIN_H
 ...
 * @since 11
 */
@protocol IArkUIXPlugin <NSObject>
@required
...
#endif // FOUNDATION_ACE_ADAPTER_IOS_ENTRANCE_PLUGINLIFECYCLE_IARKUIXPLUGIN_H