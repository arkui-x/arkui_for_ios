...
#ifndef FOUNDATION_ACE_ENGINE_ADAPTER_IOS_ENTRANCE_PICKER_PICKER_HAPTIC_CONTROLLER_H
#define FOUNDATION_ACE_ENGINE_ADAPTER_IOS_ENTRANCE_PICKER_PICKER_HAPTIC_CONTROLLER_H
...
#include "adapter/ios/capability/vibrator/audio_haptic_player.h"
#include "adapter/ios/entrance/picker/picker_haptic_interface.h"
...
private:
    ...
    std::unique_ptr<Platform::AudioHapticPlayer> audioHapticPlayer_ = nullptr;

    ACE_DISALLOW_COPY_AND_MOVE(PickerHapticController);
};
} // namespace OHOS::Ace::NG

#endif // FOUNDATION_ACE_ENGINE_ADAPTER_IOS_ENTRANCE_PICKER_PICKER_HAPTIC_CONTROLLER_H
